...
import noJsxOutsideUiLayers from "./eslint-rules/no-jsx-outside-ui-layers";
...
export default [
  ...
  },
  {
    ...
    plugins: {
      ...
      "project-rules": {
        rules: {
          ...
          "no-jsx-outside-ui-layers": noJsxOutsideUiLayers,
        },
      },
    },
    settings: {
    ...
    rules: {
      ...
      "project-rules/no-jsx-outside-ui-layers": "error",
