...
- [docs/plan/adr-gap-audit.md](../plan/adr-gap-audit.md) / [docs/plan/adr-gap-triage.md](../plan/adr-gap-triage.md) — 由来 #52(disposition: 0121 +0021/0027 でカーネル管轄書き切り)
