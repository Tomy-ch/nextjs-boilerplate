...
- [0005-library-management.md](0005-library-management.md) — `Recommended Commands` 節が参照する pnpm exact pin ルール
- [0006-git-workflow.md](0006-git-workflow.md) — `Git Rules` 節が参照する Git 運用方針
- [0007-git-hooks.md](0007-git-hooks.md) — `Code Style` / `[TODO] CI 構成` 節が参照する hook 方針
- [0009-claude-skills-operations.md](0009-claude-skills-operations.md) — Skill 実行時 Exception で参照する運用系スキル方針
- [0010-claude-skills-development.md](0010-claude-skills-development.md) — Skill 実行時 Exception で参照する開発系スキル方針
