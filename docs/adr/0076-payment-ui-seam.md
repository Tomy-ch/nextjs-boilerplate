...
[0070](0070-backend-role-separation.md)(A2)が `/api/*` を **thin proxy** に限定し、[0071](0071-bff-api-integration.md)(B3)の fetch wrapper が JSON API を前提とした結果、決済 UI の扱いが空白として残った(遡及監査 #51):
