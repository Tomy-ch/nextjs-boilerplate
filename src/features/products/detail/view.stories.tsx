...
export const Default: Story = {
  args: { imageUrls: SAMPLE_ITEM_URLS, product: product() },
};
...
export const OutOfStock: Story = {
  args: { imageUrls: SAMPLE_ITEM_URLS, product: product({ quantity: 0 }) },
};
...
export const AlreadyInCart: Story = {
  args: {
    imageUrls: SAMPLE_ITEM_URLS,
    product: product({ id: toProductId(WATCH_ID), quantity: 4 }),
  },
