 ...
 * gzip で 93 KB あり、この画面が同梱サンプルで 2 番目に重い理由でした
 * （[0101](../../../../../docs/adr/0101-performance-budget.md) §4）。
 *
 * **「見るまで取りに行かない」ではありません。** `next/dynamic` が取得を始めるのは要素がマウント
 * した時点で、画面に見えているかどうかは関係しません。得られるのは**最初に読む一式から外れること**
 * だけで、同じページを開いた人は結局そのバイトを払います。
 *
