 ...
 * ```
 *
 * @param props - native `header` 属性。`className` は既定の見た目へ追加・上書きできる。
 *
 ...
 * 使わない。
 *
 * @param props - native `h1` 属性。`className` は既定の見た目へ追加・上書きできる。
 *
 * @see Storybook `Layout/PageHeader`
 */
 ...
 *
 * @param props - native `p` 属性。`className` は既定の見た目へ追加・上書きできる。
 *
 * @see Storybook `Layout/PageHeader`
 */
