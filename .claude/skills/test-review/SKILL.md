...
`impl-review` is this skill's caller: its Step 4.5 delegates the test viewpoint here and suppresses
...
- `scope` — pre-resolved file list (skips the First Step question).
